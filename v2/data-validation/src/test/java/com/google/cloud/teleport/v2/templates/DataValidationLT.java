...
public class DataValidationLT extends TemplateLoadTestBase {
  ...
  @BeforeClass
  public static void setup() throws IOException, BigQueryResourceManagerException {
  ...
  public void testDataflow() throws IOException, ParseException, InterruptedException {
    ...
    LaunchConfig options =
        LaunchConfig.builder(testName, SPEC_PATH)
            ...
            .addParameter("configGcsLocation", System.getProperty("configGcsLocation"))
            .addParameter("sourceConnection", System.getProperty("sourceConnection"))
            .addParameter(
                "fullyQualifiedSourceTableName",
                bigQueryResourceManager.getDatasetId() + "." + SOURCE_TABLE_NAME)
            .addParameter("targetConnection", System.getProperty("targetConnection"))
            .addParameter(
                "fullyQualifiedTargetTableName",
                bigQueryResourceManager.getDatasetId() + "." + TARGET_TABLE_NAME)
            .addParameter("primaryKeys", "primary_key")
            .addParameter("partitionKey", "partition_key")
            .addParameter("partitionCount", System.getProperty("partitionCount"))
            .addParameter(
                "resultsStagingGcsLocation", System.getProperty("resultsStagingGcsLocation"))
            .addParameter(
