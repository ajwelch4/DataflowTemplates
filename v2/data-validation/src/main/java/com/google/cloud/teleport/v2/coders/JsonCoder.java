...
public class JsonCoder<T> extends CustomCoder<T> {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(JsonCoder.class);

  private static final ObjectMapper OBJECT_MAPPER =
      new ObjectMapper().configure(JsonParser.Feature.AUTO_CLOSE_SOURCE, false);
  private final Class<T> clazz;

  public JsonCoder(Class<T> clazz) {
    this.clazz = clazz;
  }
